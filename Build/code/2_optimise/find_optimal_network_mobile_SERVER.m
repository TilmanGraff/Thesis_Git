...
% define outpath
foldername = strcat(datestr(now,"yyyy-mm-dd_HHMMSS"), "_mobility_withcomp_10p")
%foldername = "2024-02-01_100131_mobility"
        ...
        if exist(strcat(outpath, "/amenities/", (countryname), ".csv"), "file")
           ...
           res_stat = solve_allocation(param,g,I, false);
            ...
            while ~converged
                ...
                new_amenities(new_amenities == 0.0) = 10^-5;
