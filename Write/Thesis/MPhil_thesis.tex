...
At the Berlin Conference of 1884--1885, European powers unilaterally decided to split up the African continent into spheres of influence amongst themselves, setting off what is known as the \emph{Scramble for Africa}. The colonising powers seized control, formed local administrative hierarchies, and set up extractive economies in their effort to transform the continent in a multitude of dimensions. 
